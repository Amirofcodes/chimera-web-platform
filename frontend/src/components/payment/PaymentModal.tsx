 ...
 * It allows users to choose between Stripe and PayPal, handles the payment
 * processing via our backend API, and provides feedback (loading, error, success).
 */
const PaymentModal: React.FC<PaymentModalProps> = ({ tier, onClose }) => {
  ...
  // Local state to manage selected payment method, loading, error, and success status.
  ...
  /**
   * handlePayment: Processes the payment based on the selected method.
   * - Validates that a payment method is selected.
   * - Calls the appropriate API endpoint to create a checkout session.
  ...
  const handlePayment = async () => {
    ...
    try {
      if (paymentMethod === 'stripe') {
        ...
        // Create a PayPal payment session via the backend API.
        ...
        <div className="space-y-4 mb-6">
          ...
          >
            ...
            <svg className="w-8" viewBox="0 0 60 25" fill="none">
             ...
             <path d="M17.5 8.5h-3.3c-.2 0-.4.1-.5.3L11.5 19c0 .2.1.3.3.3h1.7c.2 0 .4-.1.5-.3l.6-3.8c0-.2.3-.3.5-.3h1c2.2 0 3.5-1.1 3.8-3.2.1-.9 0-1.7-.4-2.2-.5-.6-1.3-1-2-1zm.4 3.2c-.2 1.2-1.1 1.2-2 1.2h-.5l.4-2.3c0-.1.1-.2.2-.2h.2c.6 0 1.2 0 1.5.3.2.3.2.6.2 1zM29.2 8.5h-3.3c-.2 0-.4.1-.5.3L23.2 19c0 .2.1.3.3.3h1.5c.2 0 .4-.1.5-.3l.4-2.6c0-.2.3-.3.5-.3h1c2.2 0 3.5-1.1 3.8-3.2.1-.9 0-1.7-.4-2.2-.5-.6-1.3-1-2.6-1.2zm.4 3.2c-.2 1.2-1.1 1.2-2 1.2h-.5l.4-2.3c0-.1.1-.2.2-.2h.2c.6 0 1.2 0 1.5.3.2.3.2.6.2 1z" fill="#253B80"/>
             <path d="M6.4 22.1l.5-3L5.7 19H1.9l2.5-15.8c0-.2.2-.3.4-.3h7.1c2.4 0 4 .5 4.8 1.5.4.5.6 1 .7 1.5.1.6 0 1.2-.1 2v.6c-.4 2.1-1.6 3.8-3.5 5-1 .6-2.1 1-3.4 1.1-1 .1-1.9 0-2.7-.2-.2 0-.4-.1-.6-.2-.2-.1-.4-.2-.5-.3l-.3 2.1.1.1z" fill="#179BD7"/>
           </svg>
         </button>
       </div>
